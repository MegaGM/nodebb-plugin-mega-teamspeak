...
* Site setters
* ---------------------------------------------*/
methods.updateLastOnlineTime = function( uid, callback ) {
...
methods.updateOnlineUsers = function( uid, callback ) {
	callback = callback || function( ) { };
	var now = Date.now( );
	db.sortedSetAdd( 'users:online', now, uid, callback );
};

methods.updateOnlineByUid = function ( uid, callback ) {
	methods.updateLastOnlineTime( uid, callback );
	methods.updateOnlineUsers( uid, callback );
};
