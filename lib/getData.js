...
module.exports = function ( data, callback ) {
	...
	var getChannels = function ( callback ) {
		...
		if ( !_.contains( data.get, 'forceReload' ) && data.channels ) return callback( null );
	...
	var getChannelGroups = function ( callback ) {
		...
		if ( !_.contains( data.get, 'forceReload' ) && data.channelGroups ) return callback( null );
	...
	var getServerGroups = function ( callback ) {
		...
		if ( !_.contains( data.get, 'forceReload' ) && data.serverGroups ) return callback( null );
